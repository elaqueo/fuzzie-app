  ...
  return (
    <header className="fixed right-0 left-0 top-0 p-4 bg-black/40 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between">
      ...
      <aside className="flex items-center gap-4">
        <Link
          href="/dashboard"
          className="relative inline-flex overflow-hidden rounded-full p-[2px] focus:outline-none focus:right-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
        >
