import { Card3D, CardBody, CardItem } from '@/components/global/card-3d';
  ...
  return (
    <main>
      ...
      <section className="mt-[-500px]">
        <LampEffect />
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-8 -mt-72">
